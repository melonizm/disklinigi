              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">0262 255 57 58</p>
                    <p className="text-gray-600">+90 532 767 79 29</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@dentaclinic.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Gebze, Kocaeli</p>
              ...
              <div className="mt-8">
                <div className="bg-gray-200 rounded-xl h-64 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p>Google Maps entegrasyonu buraya eklenecek</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg">
                <div className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center px-8 py-4 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors"
                  >
